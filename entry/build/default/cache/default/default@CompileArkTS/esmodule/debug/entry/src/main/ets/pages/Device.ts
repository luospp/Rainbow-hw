...
import { connectToDevice, disconnectDevice, getShortUUID, readCharacteristic, subscribeCharacteristic, writeCharacteristic } from "@bundle:com.amdm.newble/entry/ets/ble/helper";
    ...
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.bleWriteDialogController = new CustomDialogController({
            builder: () => {
                ...
                }, undefined, -1, () => { }, { page: "entry/src/main/ets/pages/Device.ets", line: 62, col: 14 });
...
registerNamedRoute(() => new Device(undefined, {}), "", { bundleName: "com.amdm.newble", moduleName: "entry", pagePath: "pages/Device", pageFullPath: "entry/src/main/ets/pages/Device", integratedHsp: "false", moduleType: "followWithHap" });
